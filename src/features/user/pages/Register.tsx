...
//           <label>Email</label>
//           <input type="email" required value={auth.email} onChange={e => auth.setEmail(e.target.value)} placeholder="you@example.com" />
//         </div>
//         <div className="input-group">
//           <label>Name</label>
//           <input type="text" required value={auth.name} onChange={e => auth.setName(e.target.value)} placeholder="John Doe" />
//         </div>
//         <div className="input-group">
//           <label>Phone Number</label>
//           <input type="tel" required value={auth.phoneNumber} onChange={e => auth.setPhoneNumber(e.target.value)} placeholder="+1 555-555-5555" />
//         </div>
//         <div className="input-group">
//           <label>Password</label>
//           <input type="password" required value={auth.password} onChange={e => auth.setPassword(e.target.value)} placeholder="••••••••" />
//         </div>
...
//         <button type="button" onClick={() => { navigate('/login'); auth.clearMessages(); }}>
//           Log in
//         </button>
//       </div>
//     </div>

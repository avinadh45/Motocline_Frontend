...
export default function GarageList() {
  ...
  const { fetchServiceCenters, serviceCenters } = useAdminAuth();
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            />
            {search && (
              <button onClick={() => setSearch("")} style={{ background: "none", border: "none", cursor: "pointer", color: "rgba(255,255,255,0.3)", padding: 0, fontSize: 18, lineHeight: 1 }}>×</button>
            )}
          </div>

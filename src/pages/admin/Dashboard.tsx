    ...
    >
      ...
      <div className="flex items-end gap-2">
        <span
          ...
          style={{ fontFamily: "'Syne',sans-serif", fontSize: "32px", letterSpacing: "-1px", color }}
        >
          {count.padStart(2, "0")}
        </span>
...
//   }, [navigate]);
  ...
  return (
    <div
      className="flex-1 overflow-y-auto p-6 lg:p-7"
            ...
            >
              ...
              <div className="h-1.5 rounded-full mb-1.5" style={{ background: "rgba(255,255,255,0.07)" }}>
                <div
                  ...
                  style={{ width: `${item.pct}%`, background: `linear-gradient(90deg,${item.color},${item.color}88)` }}
                />
              </div>

 ...
 const navigate = useNavigate();
  ...
  const handleSave = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setSaveError(err?.response?.data?.message || err?.message || "Failed to save category.");
    } finally {
      setSaving(false);
    }
  };
 ...
 const handleEdit = (cat: Category) => {
  ...
  return (
    <>
      ...
      <div
        style={{ background: "#080e0a", minHeight: "100vh", fontFamily: "'DM Sans', sans-serif" }}
      >
            ...
            <div style={{
              ...
              <div style={{ padding: "24px 28px" }}>
                ...
                <form onSubmit={handleSave}>
                  ...
                  {/* Feedback */}
                  {saveError && (
                    <div style={{ display: "flex", alignItems: "center", gap: "10px", borderRadius: "10px", padding: "10px 14px", marginBottom: "14px", background: "rgba(239,68,68,0.07)", border: "1px solid rgba(239,68,68,0.2)", animation: "popIn .25s ease both" }}>
                      <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="#f87171" strokeWidth="2.5" strokeLinecap="round">
                        <circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="12"/><line x1="12" y1="16" x2="12.01" y2="16"/>
                      </svg>
                      <span style={{ fontSize: "13px", color: "#f87171", fontFamily: "'DM Sans',sans-serif" }}>{saveError}</span>
                    </div>
                  )}
                  {saved && (
                ...
                paged.map((cat, i) => (
                  <div
                    ...
                    style={{
                      ...
                      borderBottom: i < paged.length - 1 ? "1px solid rgba(255,255,255,0.038)" : "none",

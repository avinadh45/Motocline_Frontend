...
import type { MechanicResponse } from "../../interface/mechanic/Mechanic";
...
export default function MechanicPage() {
  ...
  const fetchMechanics = async () => {
    try {
      ...
      const mapped = data.map((m: MechanicResponse) => ({
        id: m.id,
                ...
                {paged.length === 0 ? (
                  ...
                  paged.map((m, i) => (
                    <tr
                      ...
                      style={{
                        borderBottom: i < paged.length - 1 ? "1px solid rgba(255,255,255,0.04)" : "none",
